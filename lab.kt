 ...
 */
 ...
 fun filtrarNumeros(numeros: List<Int>): List<Int> = numeros.filter { x -> x % 2 != 0 }
 ...
 fun performOperation(num1: Int, num2: Int, operation: (Int, Int) -> Int): Int = operation(num1, num2)
 ...
 fun main() {
     ...
     println("Promedio de la lista : ${calcularPromedio(numeros)}")
     ...
     var palabra = "Hola"
     println("\n$palabra es palindromo¨? : ${verificarPalindromo(palabra)}")
